...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/findOrderByManyConditionaction"
		method="post">
							...
							<c:forEach items="${orders}" var="order">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/findOrderByIdaction?id=${order.id}&type=admin">
											<img
									...
									-->
											<a
												href="${pageContext.request.contextPath}/delOrderByIdaction?id=${order.id}&type=admin">
												<img
