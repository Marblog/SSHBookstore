...
<div class="dtree">
  ...
  <tr>
  	<td><a href="${pageContext.request.contextPath}/listproductsaction" target="mainFrame" class="left_list">商品管理</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/findorder" target="mainFrame" class="left_list">订单管理</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/listNoticeaction" target="mainFrame" class="left_list">公告管理</a></td>
  </tr>
  <tr>
  	<td><a href="${pageContext.request.contextPath}/#" target="mainFrame" class="left_list">用户管理</a></td>
  </tr>
   <tr>
  	<td><a href="${pageContext.request.contextPath}/loginoutaction" target="mainFrame" class="left_list">退出系统</a></td>
  </tr>
</table>
</body>
</html>
