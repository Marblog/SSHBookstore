...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/findproductsbymanyconditionstaction"
		method="post">
							...
							<c:forEach items="${ps}" var="p">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/findProductsByIdAction?id=${p.id}">
											<img
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/productsdelaction?id=${p.id}">
											<img
